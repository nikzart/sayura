...
export default function LookbookGrid({ collections }: LookbookGridProps) {
  return (
      ...
      <div className="container-custom">
        ...
        <div className="space-y-24">
          {collections.map((collection, index) => {
            const slug = typeof collection.slug === 'string' ? collection.slug : collection.slug?.current;
            const imageUrl = collection.image ? getSanityImageUrl(collection.image, 1200, 1600) : '';
